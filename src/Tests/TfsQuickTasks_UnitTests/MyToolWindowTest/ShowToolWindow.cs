...
using ChrisTaylor.TfsQuickTasks;

namespace TfsQuickTasks_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new TfsQuickTasksPackage() as IVsPackage;
            ...
            MethodInfo method = typeof(TfsQuickTasksPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
